...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function () {
        ...
        Route::group(['prefix' => 'payments'], function () {
            ...
            Route::post('/get_student_payments', [PaymentController::class, 'get_student_payments'])->name('get_student_payments');
            Route::get('/payments/view/{id}', [PaymentController::class, 'view']);
            Route::get('/payments/edit/{id}', [PaymentController::class, 'edit_student_payment']);
